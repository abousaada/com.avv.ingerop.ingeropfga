...
sap.ui.define([
    ...
    return Controller.extend("com.avv.ingerop.ingeropfga.ext.controller.helpers.BudgetPxSTG", {
        ...
        _createGroupeColumn: function (sColumnId, { subContractorName, subContractorId, subContractorCoef, profitCenter, columnId }) {
            return new sap.ui.table.Column({
                multiLabels: [
                    new sap.m.Label({ text: subContractorName }),
        ...
        addFilialeDynamicColumns() {
            const STF = this.oView.byId(this._CONSTANT_STF_TABLE_ID);
